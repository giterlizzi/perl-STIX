...
L<STIX::Marking::TLP::Green> inherits all methods from L<STIX::Base>
...
Convert L<STIX::Marking::TLP::Green> in JSON.
...
Validate L<STIX::Marking::TLP::Green> object using JSON Schema (see L<STIX::Schema>).
