...
L<STIX::Marking::TLP::Red> inherits all methods from L<STIX::Base>
...
Convert L<STIX::Marking::TLP::Red> in JSON.
...
Validate L<STIX::Marking::TLP::Red> object using JSON Schema (see L<STIX::Schema>).
